/** Home page FAQ copy (used by FAQ section + homepage JSON-LD). */
...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes — 100% free towing anywhere in Greater Brisbane, including Ipswich, Logan, Redland Bay, and Moreton Bay. There are no hidden deductions from your agreed quote. The price we offer is the price you receive in cash.",
  },
  {
