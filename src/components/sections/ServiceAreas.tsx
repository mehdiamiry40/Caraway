...
const areaRowClassName =
  "group flex min-h-[2.75rem] items-center gap-2.5 rounded-lg border border-border/50 bg-white px-3.5 py-2.5 text-left text-xs sm:text-sm font-medium text-foreground transition-all hover:border-primary hover:bg-primary hover:text-primary-foreground hover:shadow-sm";

const areaIconWrapClassName =
  "flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-accent/10 text-accent group-hover:bg-white/15 group-hover:text-primary-foreground transition-colors";
...
export function ServiceAreas() {
  return (
    <section
      className="relative section-y bg-[hsl(35,30%,96%)]"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-10 lg:mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            ...
            <Link
              href="/locations"
              className="inline-flex items-center justify-center gap-2 rounded-lg border-2 border-primary/20 bg-transparent px-5 py-3 text-sm font-semibold text-primary transition hover:bg-primary hover:text-primary-foreground hover:border-primary"
            >
              All locations
        ...
        {/* Browse by area */}
        <div className="rounded-xl border border-border/50 bg-white p-5 sm:p-6 lg:p-8">
        ...
        {/* Not in list CTA */}
        <div className="mt-10 max-w-3xl mx-auto rounded-xl border border-border/50 bg-white px-6 py-6 text-center sm:px-10">
